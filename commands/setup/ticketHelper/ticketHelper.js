...
$channelSendMessage[$get[channelID];{
    ...
    "embeds": "{newEmbed:{title:<#COLON#peppapigshoppe_happypeppa#COLON#1060268959724740720> Hello Shopper!}{description:Want to order or report now? Click the Green Button below to make an <:peppapigshoppe:1057625427029540904>Order Form and Red Button for the <:peppapigshoppe_report:1061638968195690577>Report Form!\\n\\n📌 If the bot is offline, please send the format manually from <#1059307766684073984> channel.}{footer:Thank you for ordering/reporting}{color:$get[clr]}}",
...
$interactionReply[;{newEmbed:{author:$userTag:$authorAvatar}{title:<:peppapigshoppe:1057625427029540904> | Order Form Submitted!}{fields:$get[arrow] Name of Item/s#COLON#,\` $get[item] \`,no:$get[arrow] Quantity#COLON#,\` $get[quantity] \`,yes:$get[arrow] Mode of payment#COLON#,\` $get[payment] \`,yes}{footer:Thank you for submitting an order form, please wait for @yskaela#2022 to process it.}{color:$get[clr]}}]
