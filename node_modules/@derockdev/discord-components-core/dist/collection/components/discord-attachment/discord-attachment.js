  ...
  render() {
    switch (this.type) {
      ...
      case DiscordAttachmentType.VIDEO:
        return (h(Host, { class: "discord-attachment" }, h("div", { class: "discord-image-wrapper", style: { height: `${this.height}px`, width: `${this.width}px` } }, h("video", { src: this.url, height: this.height, width: this.width }))));
